...
public class ClientCryptography {
    ...
    /**
     * NOTE: Cryptography is applied to the communication between public server and home server.
     * In this relation, home server (this application) is the client to the public server.
     *
     ...
     * 3. Client encrypts AES key, IV, MAC-key with main's public key (asymmetric encryption).
     ...
     * 6. Server decrypts AES-key, IV, MAC-key with main.Server's private key (asymmetric decryption).
     ...
     * (at both client and main end) additional information would need to be given
     * to inform the main of which client's password it should generate symmetric key from.
