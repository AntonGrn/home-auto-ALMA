...
Example of three automation rules illustrating the following use cases:
1. A coffee machine timer turning itself off and turning a lamp on when the timer has expired (30 min).
