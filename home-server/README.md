...
Below is an example illustrating gadgets of different architectures and types.
```yaml
{
  "alma": [
    {
...
Below is an example of three automations illustrating the following use cases:
